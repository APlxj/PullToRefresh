package com.scwang.refreshlayout.view;
...
public class RealtimeBlurView extends View {
    ...
    public RealtimeBlurView(Context context, AttributeSet attrs) {
        ...
        mBlurRadius = a.getDimension(0, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
        mDownsampleFactor = a.getFloat(1, 4);
        mOverlayColor = a.getColor(2, 0xAAFFFFFF);
        a.recycle();
    }
    ...
    static {
        try {
            com.github.mmin18.widget.RealtimeBlurView.class.getClassLoader().loadClass("android.support.v8.renderscript.RenderScript");
